...
```
In fact we can see that **women** results more stressed then men, as said in [this](https://psycnet.apa.org/record/1999-10525-006)
...
Northern Eu's Countries result **less stressed** and trust more in their authority rules to block the pandemic ,on the other side 
