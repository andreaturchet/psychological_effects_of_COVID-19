...
More informations about **PS Scale** [here](https://www.midss.org/content/perceived-stress-scale-pss)
...
```{r genderstressplot, fig.cap="Level of stress by Gender", fig.align='center'}
...
```
From what emerges **women** result more stressed then men.
...
```{r plotstressovertime, fig.cap="Level of stress during the first weeks of the pandemic"}
...
```{r map, fig.cap="Level of stress during the first weeks of the pandemic, based on PSS Scale", fig.align='center'}
worldMap <- getMap()
...
**Women** result more stressed than men, as stated in [this](https://psycnet.apa.org/record/1999-10525-006)
Psychological article.
Remarkably, around the Europe the **Country's healthcare system** is trusted followed by the **WHO**. 
There is a strong negative correlation between an high level of stress and a lack of trust in governments, indeed citizens of northern Europe's countries are less stressed and they have also an high level of confidence in their governments.
